...
public interface ShopCartDao {
     ...
     * @return
     */
    int deleteShopCart(@Param("listCode") List<String> listCode, @Param("userId") String userId);
     ...
     * @return
     */
    int deleteShopCartTwo(@Param("listCode") List<String> listCode, @Param("userId") String userId);
