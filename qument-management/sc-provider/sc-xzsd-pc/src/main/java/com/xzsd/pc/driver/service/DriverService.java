...
public class DriverService {
    ...
    public AppResponse updateDriver(DriverInfo driverInfo) {
        ...
        String pwd = PasswordUtils.generatePassword(driverInfo.getDriverPassword());
    ...
    public AppResponse listDriver(DriverList driverList) {
        ...
        //传入登录者角色
        driverList.setUserRole(loginInfo.getUserRole());
        //传入登录者编号
        driverList.setUserCode(loginInfo.getLoginCode());
