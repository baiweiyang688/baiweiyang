...
public class HotGoodsService {
    ...
    public AppResponse addHotGoods(HotGoodsInfo hotGoodsInfo) {
        if(hotGoodsInfo.getGoodsCode() == null || "".equals(hotGoodsInfo.getGoodsCode())){
            return AppResponse.bizError("请选择商品");
        }
        if(hotGoodsInfo.getHotSort() == 0 || "".equals(hotGoodsInfo.getHotSort())){
            return AppResponse.bizError("请输入热门商品排序序号");
        }
        //检验热门商品排序是否重复
