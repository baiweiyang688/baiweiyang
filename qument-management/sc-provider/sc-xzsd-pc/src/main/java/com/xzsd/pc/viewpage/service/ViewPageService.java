package com.xzsd.pc.viewpage.service;
...
import com.xzsd.pc.viewpage.dao.ViewPageDao;
import com.xzsd.pc.viewpage.entity.GoodsViewPageInfo;
import com.xzsd.pc.viewpage.entity.ViewPageInfo;
import com.xzsd.pc.viewpage.entity.ViewPageMes;
...
//        }
    ...
    public AppResponse listGoods(GoodsViewPageInfo goodsViewPageInfo) {
        PageHelper.startPage(goodsViewPageInfo.getPageNum(), goodsViewPageInfo.getPageSize());
