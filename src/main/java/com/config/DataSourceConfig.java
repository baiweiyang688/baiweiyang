...
//                .tableShardingStrategy(new TableShardingStrategy("goods_code", new TableShardingAlgorithm()))
...
//                .databaseShardingStrategy(new DatabaseShardingStrategy("goods_code", new DatabaseShardingAlgorithm()))
//                .tableShardingStrategy(new TableShardingStrategy("goods_code", new TableShardingAlgorithm()))
//                .build();
//    }
//
